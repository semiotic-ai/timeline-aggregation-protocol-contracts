...
export interface TAPVerifierTestInterface extends utils.Interface {
  functions: {
    ...
    "testEdgeCaseMaxValuedRav()": FunctionFragment;
    "testEdgeCaseMinValuedRav()": FunctionFragment;
    "testInvalidSignature()": FunctionFragment;
    "testRAVInvalidAllocationID()": FunctionFragment;
    "testRAVInvalidTimestamp()": FunctionFragment;
    "testRAVInvalidValueAggregate()": FunctionFragment;
    "testRecoverSignature()": FunctionFragment;
    "testSampledValidRAV()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testEdgeCaseMaxValuedRav",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testEdgeCaseMinValuedRav",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testInvalidSignature",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testRAVInvalidAllocationID",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testRAVInvalidTimestamp",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testRAVInvalidValueAggregate",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testRecoverSignature",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testSampledValidRAV",
    values?: undefined
  ): string;
...
export interface TAPVerifierTest extends BaseContract {
  ...
  callStatic: {
    ...
    testEdgeCaseMaxValuedRav(overrides?: CallOverrides): Promise<void>;

    testEdgeCaseMinValuedRav(overrides?: CallOverrides): Promise<void>;

    testInvalidSignature(overrides?: CallOverrides): Promise<void>;

    testRAVInvalidAllocationID(overrides?: CallOverrides): Promise<void>;

    testRAVInvalidTimestamp(overrides?: CallOverrides): Promise<void>;

    testRAVInvalidValueAggregate(overrides?: CallOverrides): Promise<void>;

    testRecoverSignature(overrides?: CallOverrides): Promise<void>;

    testSampledValidRAV(overrides?: CallOverrides): Promise<void>;
  };
