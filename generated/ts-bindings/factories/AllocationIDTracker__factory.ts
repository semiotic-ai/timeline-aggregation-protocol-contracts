...
import type {
  AllocationIDTracker,
  AllocationIDTrackerInterface,
} from "../AllocationIDTracker";
...
type AllocationIDTrackerConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: AllocationIDTrackerConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class AllocationIDTracker__factory extends ContractFactory {
  constructor(...args: AllocationIDTrackerConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override attach(address: string): AllocationIDTracker {
    return super.attach(address) as AllocationIDTracker;
  }
  override connect(signer: Signer): AllocationIDTracker__factory {
    return super.connect(signer) as AllocationIDTracker__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): AllocationIDTrackerInterface {
    return new utils.Interface(_abi) as AllocationIDTrackerInterface;
  }
  static connect(
    address: string,
