...
export interface TAPDeployScriptInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "IS_SCRIPT" | "run" | "setUp" | "test"
  ): FunctionFragment;
...
export interface TAPDeployScript extends BaseContract {
  ...
  test(overrides?: Overrides & { from?: string }): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    test(overrides?: Overrides & { from?: string }): Promise<BigNumber>;
  };
