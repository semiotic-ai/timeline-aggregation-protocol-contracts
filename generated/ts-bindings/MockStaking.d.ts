...
interface MockStakingInterface extends Interface {
  functions: {
...
export class MockStaking extends Contract {
  connect(signerOrProvider: Signer | Provider | string): MockStaking;
  attach(addressOrName: string): MockStaking;
  deployed(): Promise<MockStaking>;

  on(event: EventFilter | string, listener: Listener): MockStaking;
  once(event: EventFilter | string, listener: Listener): MockStaking;
  addListener(eventName: EventFilter | string, listener: Listener): MockStaking;
  removeAllListeners(eventName: EventFilter | string): MockStaking;
  removeListener(eventName: any, listener: Listener): MockStaking;
